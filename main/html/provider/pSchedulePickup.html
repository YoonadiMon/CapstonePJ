...
<body>
    ...
    <main>
        ...
        <div class="psp-back-row">
            <a href="pHome.html" class="psp-back-btn">
        ...
        <div class="psp-layout">
                ...
                <div class="psp-card">
                    ...
                    <div class="psp-form-grid">
                        <div class="psp-form-group full-width">
                            ...
                            <input type="text" class="psp-form-control" id="pickupAddress" placeholder="Street address, building, unit no." value="No. 15, Jalan SS15/4">
                        </div>
                        ...
                        <div class="psp-form-group">
                            ...
                            <input type="text" class="psp-form-control" id="pickupPostcode" placeholder="e.g., 47500" value="47500">
                        </div>
                    </div>
                </div>
                ...
                <div class="psp-card">
                    ...
                    <div class="psp-datetime-grid">
                        <div class="psp-form-group">
                            ...
                            <input type="date" class="psp-form-control" id="preferredDate" min="2026-02-24" value="2026-02-25">
                        </div>
            ...
            <div class="psp-summary-col">
                <div class="psp-summary-card">
                    ...
                    <button class="psp-submit-btn" onclick="submitPickupRequest()" id="submitBtn">
    ...
    <script>
        ...
        function loadProviderData() {
            // Simulate loading provider data from database
            // In production, this would come from the Provider table via userID
            
            const providerData = {
                address: 'No. 15, Jalan SS15/4',
                state: 'Kuala Lumpur',
                postcode: '47500'
            };
            
            // Pre-fill form with provider's default address
            document.getElementById('pickupAddress').value = providerData.address;
            document.getElementById('pickupState').value = providerData.state;
            document.getElementById('pickupPostcode').value = providerData.postcode;
        }
                    ...
                    <div class="psp-item-grid">
                        <div class="psp-item-field">
                            ...
                            <select onchange="updateSummary()">
                                ...
                                ${eWasteTypes.map(type => `<option value="${type}">${type}</option>`).join('')}
                            </select>
                        </div>
                        <div class="psp-item-field">
                            <label>Brand</label>
                        ...
                        <div class="psp-item-field">
                            ...
                            <input type="number" min="1" value="1" onchange="updateSummary()">
                        </div>
                        <div class="psp-item-field">
                        ...
                        <div class="psp-item-field">
                            ...
                            <input type="text" placeholder="LxWxH" onchange="updateSummary()">
                        </div>
                        <div class="psp-item-field">
        ...
        function updateSummary() {
            ...
            // Points per kg by item type (simplified calculation)
            const pointsRate = {
                'Smartphone': 200,
                'Laptop': 400,
            ...
            itemCards.forEach((card, index) => {
                ...
                // Calculate points based on type and weight
                if (type && weight > 0) {
                    const rate = pointsRate[type] || 100;
                    estimatedPoints += Math.round(weight * quantity * rate);
                }
            });
            
            // Update summary
            document.getElementById('summaryItemsCount').textContent = totalItems + ' items';
        ...
        function submitPickupRequest() {
            ...
            const requestData = {
                // Collection Request table fields
                providerID: 'PRV-2024-00182', // From Provider table
                ...
                images: uploadedImages.map(img => img.data) // Base64 images
            };
            ...
            setTimeout(() => {
                ...
                localStorage.setItem('lastPickupRequest', JSON.stringify(requestData));
        ...
        function collectItemData() {
            ...
            itemCards.forEach(card => {
                ...
                items.push({
                    ...
                    condition: inputs[6]?.value || 'Working',
                    description: inputs[7]?.value || '',
                    status: 'Pending' // Item status from schema
                });
            });
