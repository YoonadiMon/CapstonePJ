...
<script>
    // pSchedulePickup.js with Enhanced Validations - COMPLETE VERSION WITH 10-DAY ADVANCE NOTICE
    ...
    function isValidPickupDate(dateStr) {
        ...
        if (selectedDate < minDate) {
            ...
            return { valid: false, message: `Pickup date must be at least 10 days from now (earliest: ${minDateFormatted})` };
        }
        ...
        if (itemCards.length === 0) {
            ...
            if (!hasValidItem && itemCards.length > 0) {
                if (firstErrorMsg) {
                    ...
                    showFieldError('items', 'Please fill in all required fields for at least one item');
                }
                isValid = false;
            }
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        dateHelpText.innerHTML = `📅 Pickup requests require 10 days advance notice.`;
            ...
            <div class="psp-item-card" id="${itemId}">
                ...
                <div class="psp-item-grid">
                    ...
                    <div class="psp-item-field">
                        ...
                        <input type="text" placeholder="Brief description" oninput="updateSummary(); hideFieldError('items')" maxlength="200">
                    </div>
                    <div class="psp-item-field">
